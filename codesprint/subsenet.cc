...
int n = 4; /* The number of objects */
int c[10] = {1, 2, 3, 4, 1, 2, 3, 4}; /* c[i] is the *COST* of the ith object; i.e. what
				YOU PAY to take the object */
int v[10] = {10, 20, 30, 40, 15, 15, 15, 50}; /* v[i] is the *VALUE* of the ith object; i.e.
